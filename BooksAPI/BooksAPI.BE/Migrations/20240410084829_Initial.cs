    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryMangas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryMangasId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorLibraryManga", x => new { x.AuthorsId, x.LibraryMangasId });
                    table.ForeignKey(
                        name: "FK_AuthorLibraryManga_Authors_AuthorsId",
                        column: x => x.AuthorsId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorLibraryManga_LibraryMangas_LibraryMangasId",
                        column: x => x.LibraryMangasId,
                        principalTable: "LibraryMangas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectionStatus = table.Column<string>(type: "text", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    LibraryMangaId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMangas_LibraryMangas_LibraryMangaId",
                        column: x => x.LibraryMangaId,
                        principalTable: "LibraryMangas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorLibraryManga_LibraryMangasId",
                table: "AuthorLibraryManga",
                column: "LibraryMangasId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMangas_LibraryMangaId",
                table: "UserMangas",
                column: "LibraryMangaId");
