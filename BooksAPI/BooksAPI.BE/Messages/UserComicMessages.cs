...
public static class UserComicMessages
{
    ...
    public static readonly string ReadingStatusValidationMessage =
        $"Reading status must be one of the following: " + String.Join(", ", UserComicConstants.ReadingStatus.ReadingStatuses);
    ...
    public static readonly string CollectionStatusValidationMessage =
        $"Collection status must be one of the following: " + String.Join(", ", UserComicConstants.CollectingStatus.CollectingStatuses);
